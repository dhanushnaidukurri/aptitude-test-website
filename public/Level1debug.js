var quiz = {
    ...
    {
    "id": 2,
    "question": "Which of the following is NOT a common type of programming error?",
    "options": [
    {
    "a": "Syntax errors",
    "b": "Logical errors    ",
    ...
    {
    "id": 10,
    "question": "What does the term stepping over mean in debugging?",
    "options": [
    {
    "a": "Skipping the current line of code",
    "b": "Repeating the current line of code",
    "c": "Moving to the next function    ",
    "d": "Ignoring breakpoints",
    }
    ],
    "answer": "Skipping the current line of code",
    "score": 0,
    "status": ""
    },
    ]}
