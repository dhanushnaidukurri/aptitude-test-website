var quiz = {
    ...
    {
    "id": 1,
    "question": "Using transient code, ___ the size of the operating system during program execution.",
    "options": [
    {
    "a": "maintains",
    "b": "changes",    
    ...
    {
    "id": 3,
    "question":  "The operating system maintains a __ table that keeps track of how many frames have been allocated, how many are there, and how many are available.",
    "options": [
    {
    "a": "memory",
    "b": "mapping",
    ...
    {
    "id": 4,
    "question": "The ___ presents a uniform device-access interface to the I/O subsystem, much as system calls provide a standard interface between the application and the operating system.",
    "options": [
    {
    "a": "Device drivers",
    "b": "I/O systems",
